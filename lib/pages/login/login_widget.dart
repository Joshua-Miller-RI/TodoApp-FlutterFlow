...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.sEmailTextController ??= TextEditingController();
    _model.sEmailFocusNode ??= FocusNode();
    ...
    _model.lLoginTextController ??= TextEditingController();
    _model.lLoginFocusNode ??= FocusNode();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.sEmailTextController,
                                          focusNode: _model.sEmailFocusNode,
                                          onChanged: (_) =>
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.sPasswordFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          textInputAction: TextInputAction.next,
                                          obscureText:
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.sConfirmPasswordFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          textInputAction: TextInputAction.next,
                                          obscureText: !_model
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.lLoginTextController,
                                          focusNode: _model.lLoginFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.lLoginTextController',
                                            Duration(milliseconds: 2000),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.lLoginTextController.text,
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              GoRouter.of(context).prepareAuthEvent();
                              if (_model.sPasswordTextController.text !=
                                  _model.sConfirmPasswordTextController.text) {
                              ...
                              final user =
                                ...
                                context,
                                _model.sEmailTextController.text,
                              ...
                              await UsersRecord.collection
                                  ...
                                  .update(createUsersRecordData(
                                    email: _model.sEmailTextController.text,
